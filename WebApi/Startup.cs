...
namespace WebApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<EntidadContext>(opt => opt.UseSqlServer("Server = (localdb)\\MSSQLLocalDB; Database = BANCOC; Trusted_Connection = True; MultipleActiveResultSets = true"));
            services.AddScoped<IUnitOfWork, UnitOfWork>(); //Se Instancia un peticion
            services.AddScoped<IDbContext, EntidadContext>();
